...
export const asyncRouterMap: AppRouteRecordRaw[] = [
  ...
  },
  {
    ...
    component: Layout,
    redirect: '/systemmanagement/log',
    name: 'Management',
    meta: {
      title: t('router.management'),
      icon: 'vi-ant-design:management-filled',
      alwaysShow: true
    },
    children: [
      {
        path: 'log',
        component: () => import('@/views/SystemManagement/Log/Log.vue'),
        name: 'Log',
        meta: {
          title: t('router.log')
        }
      ...
      {
        path: 'configuration',
        component: () => import('@/views/SystemManagement/Configuration/Configuration.vue'),
        name: 'Configuration',
        meta: {
