...
const emit = defineEmits(['search', 'reset', 'expand', 'statistic', 'notProcessing', 'exportData'])
...
defineProps({
  ...
  showStatistic: propTypes.bool.def(false),
...
<template>
  ...
  <BaseButton v-if="showStatistic" type="warning" @click="onStatistic">
    {{ t('merchantList.statistics') }}
  </BaseButton>
</template>
