...
const emit = defineEmits(['search', 'reset', 'register', 'validate', 'show-dialog'])
              ...
              return (
                <div>
                  <ActionButton
                    ...
                    showAddCategory={propsComputed.showAddCategory}
                    showAddStatistics={propsComputed.showAddStatistics}
  ...
  <template v-if="layout === 'bottom'">
    <div :style="bottomButtonStyle">
      <ActionButton
        ...
        :show-add-category="getProps.showAddCategory"
        :show-add-statistics="getProps.showAddStatistics"
